    ...
    try {
      ...
      switch (category) {
        case "Housing":
          ...
          formData.append("zoning_status", zoning_status);
          formData.append("parcel_no", parcel_no);
          formData.append("island_no", island_no);
